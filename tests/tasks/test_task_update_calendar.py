...
def test_task_update_calendar(
    celery_worker, celery_app, mock_airbnb_client, status_code, response_queue, responses_model
):

    response_queue.put({"status_code": status_code, "content": pg.calendar_generator()})
